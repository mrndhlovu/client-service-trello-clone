...
const textHoverEffect = color => css`
  &:hover {
    color: ${color};
...
const transitionEffect = property => css`
  transition: 500ms;
  transition-property: ${property};
  transition-timing-function: ease-in-out;
`

const lineClamp = numberOfLines => css`
  overflow: hidden;
...
const placeholderColor = placeholderColor => css`
...
const gradientColor = (value, deg) => css`
  background: ${value === "a"
...
const gradientBg = (value, deg) => css`
  background: ${value === "a"
